...
int main( )
{
    ...
    cout << "First number is init as: " << firstNum << endl
    << "Second number is init as: " << secondNum << endl;

    getNumbers(firstNum, secondNum);
    cout << "First number is now: " << firstNum << endl
        << "Second number is now: " << secondNum << endl;
